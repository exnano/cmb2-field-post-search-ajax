...
if (!class_exists('MAG_CMB2_Field_Post_Search_Ajax')) {
	...
	class MAG_CMB2_Field_Post_Search_Ajax
	{
		...
		public static function url($path = '')
		{
			 ...
			 */
			$cmb2_fpsa_dir = trailingslashit(plugin_dir_url(__FILE__));
		...
		{
			wp_register_script('jquery-devbridge-autocomplete', self::url('js/jquery.autocomplete.min.js'), array('jquery'), self::VERSION);
			wp_register_script('mag-post-search-ajax', self::url('js/mag-post-search-ajax.js'), array('jquery', 'jquery-devbridge-autocomplete', 'jquery-ui-sortable'), self::VERSION, true);
